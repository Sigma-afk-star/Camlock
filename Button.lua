...
TextButton.MouseButton1Click:Connect(function()
    ...
    TextButton.Text = CamlockState and "Shift On" or "Shift Off"
    ...
    if CamlockState then
        ...
        if enemy then
            ...
            StarterGui:SetCore("SendNotification", {
                ...
                Text = "Target Locked: " .. enemy.DisplayName,
                Duration = 3
            })
        end
    else
